...
#spawns random mob
execute if score timer_dummy mob_seconds matches 10 run function random_mob:spawn_mob
execute if score timer_dummy mob_seconds matches 10 run scoreboard players set timer_dummy mob_seconds 0
