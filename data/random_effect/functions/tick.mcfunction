...
#loades timer
execute if score @r random_effect_switch matches 1 run tellraw @a [{"text":"Random Effect: ","color":"gold","bold":true},{"text":"Challenge started!","color":"dark_green"}]
...
execute if score @r random_effect_switch matches 3 run tellraw @a [{"text":"Random Effect: ","color":"gold","bold":true},{"text":"Challenge stopped!","color":"dark_green"}]
