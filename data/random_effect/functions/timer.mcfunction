...
#gives random effect
execute if score timer_dummy effect_seconds = effect_delay run function random_effect:give_effect
execute if score timer_dummy effect_seconds = effect_delay run scoreboard players set timer_dummy effect_seconds 0
